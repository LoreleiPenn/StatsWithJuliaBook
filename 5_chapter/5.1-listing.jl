...
# ╔═╡ d0c62d88-4430-11ec-1bce-9fb11224a1ff
using Random, Distributions, Plots,PlutoUI

# ╔═╡ 93dd01a6-102c-4959-a94e-ce25f57d216a
λ = 1/4.5

# ╔═╡ f93b31ad-30e5-4cda-807e-3ce006344e83
expDist = Exponential(1/λ)

# ╔═╡ bd8a4a00-4bad-43ec-adc4-c2a4d5ee452e
n, N = 10, 10^4

# ╔═╡ a6a0c4ed-4fb0-407f-9f2b-0089a1725c91
data = rand(expDist, (n, N))

# ╔═╡ fe2b3aee-abfe-4630-b6d2-e3d816fcc0ee
means = mapslices(mean, data, dims = [1])

# ╔═╡ b978953f-5e73-4484-911a-416c1b9d44e2
variances = mapslices(var, data, dims = [1])

# ╔═╡ 1960c8e1-b6dd-4d96-bb5e-31d758a3c540
with_terminal() do
	println("Actual mean: $(mean(expDist))\nMean of sample means: $(mean(means))")
	println("Actual mean: $(var(expDist))\nMean of sample means: $(mean(variances))")
end

# ╔═╡ 84597b68-3885-45da-a4c0-2929b39798ac
begin
